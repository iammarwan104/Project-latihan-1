...
export default function () {
    return (
        <section id="dashboard" className="h-screen w-screen px-8 md:px-16 lg:px-32 flex justify-between items-center">
            ...
            <img src={hero_1} alt="..." width={300} height={300} className=" hidden md:block md:w-[210.16px] lg:w-[260.16px] xl:w-[310.16px] h-auto" />
        </section>
    )
}