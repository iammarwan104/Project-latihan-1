...
export default function Unsent() {
    return (
        <section id='unsent' className="grid grid-cols-1 md:grid-cols-[1.5fr_2fr] gap-12 items-center justify-between py-8 px-8 md:px-16 lg:px-32">
            <img src={hero2} alt="hero 2" width={300} height={300} className='w-[70%] mx-auto md:w-full xl:w-[80%] h-auto mb-2 md:mb-0' />
