...
export default function Design() {
    return (
        <section id='design' className=" h-screen grid grid-cols-1 md:grid-cols-[1.5fr_2fr] items-center px-8 md:px-16 lg:px-32">
            <img src={hero3} alt="hero 2" width={300} height={300} className=' w-full mb-2 xl:w-[70%]' />
            <div className=''>
