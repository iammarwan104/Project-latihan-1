...
export default function Design() {
  ...
  const isInView = useInView(ref, {once : true});
    return (
        <section id='design' ref={ref} className={`relative ${
            isInView? "bottom-0 opacity-100" : "-bottom-52 opacity-0"
          } duration-700 delay-[.5s] ease-in-out grid grid-cols-1 md:grid-cols-[1.5fr_2fr] py-8 gap-12 items-center px-8 md:px-16 lg:px-32`}>
