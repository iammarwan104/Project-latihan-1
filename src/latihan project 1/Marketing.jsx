...
export default function Marketing() {
    ...
    const [showDesignItems, setShowDesignItems] = useState(false);
    window.addEventListener("scroll", () => {
      if (window.scrollY > 2700) {
        setShowDesign(true);
        setShowDesignItems(true);
      }
    });
    return (
        <section id='marketing' className={`relative ${
            showDesignItems? "bottom-0 opacity-100" : "-bottom-52 opacity-0"
            ...
            <div className='grid grid-cols-1 md:grid-cols-3 gap-16 md:gap-4'>
                ...
                <div className={` relative ${showDesignItems ? 'top-0 opacity-1' : 'relative top-52 opacity-0'} duration-700 delay-100 ease-in-out`}>
                ...
                <div className={` relative ${showDesignItems ? 'top-0 opacity-1' : 'relative top-52 opacity-0'} duration-700 delay-200 ease-in-out`}>
                ...
                <div className={` relative ${showDesignItems ? 'top-0 opacity-1' : 'relative top-52 opacity-0'} duration-700 delay-300 ease-in-out`}>
