...
export default function Marketing() {
    ...
    return (
        <section id='marketing' ref={ref} className={`relative ${
            isInView? "bottom-0 opacity-100" : "-bottom-52 opacity-0"
          } duration-700 delay-[.4s] ease-in-out px-8 md:px-16 lg:px-32 pt-16 pb-24 bg-white`}>
            ...
            <div className='grid grid-cols-1 md:grid-cols-3 gap-16 md:gap-4'>
                ...
                <div className={` relative ${isInView ? 'top-0 opacity-1' : 'relative top-52 opacity-0'} duration-700 delay-[.5s] ease-in-out`}>
                ...
                <div className={` relative ${isInView ? 'top-0 opacity-1' : 'relative top-52 opacity-0'} duration-700 delay-[.6s] ease-in-out`}>
                ...
                <div className={` relative ${isInView ? 'top-0 opacity-1' : 'relative top-52 opacity-0'} duration-700 delay-[.7s] ease-in-out`}>
